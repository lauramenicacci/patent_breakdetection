...
models$is[[27]] # low income countries
...
## Visualize
```{r}
plot(models$is[[28]]) # high income countries, ar = 1, logs, pval = 0.001, ihs y

plot(models$is[[32]]) # low income countries, ar = 1, logs, pval = 0.001, ihs y

```
## Plot residuals
```{r}
plot_residuals(models$is[[28]])

plot_residuals(models$is[[32]])
```
