...
```{r}
pat_dev <- read_csv("D:\\PAT_DEV_02022023120219870.csv")
...
last_10 <- c("Pendleton-Hermiston - OR", "San Angelo - TX", "Bismarck - ND")
...
ggsave("Y02E_patents_bylast.png", plot = fig_last, device = "png", width = 10, height = 8)
