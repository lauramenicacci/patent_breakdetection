...
pat <- read_csv("D:\\PCT_EPO_counts\\patent_count_pct_direct_epo_regshare.csv", show_col_types = FALSE)
...
saveRDS(models, ".\\results\\models_nonpat_regshare.RDS")
...
situa <- readRDS(".\\results\\models_nonpat_regshare.RDS")
